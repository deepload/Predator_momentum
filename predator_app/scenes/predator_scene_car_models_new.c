...
static const CarModelInfo car_models[] = {
    {"Honda", "Civic 2010-2015", 433920000, "Rolling Code"},
    {"Toyota", "Corolla 2012+", 433920000, "Fixed Code"},
    {"Mazda", "3 2010-2013", 315000000, "Rolling Code"},
    {"Nissan", "Altima 2015+", 433920000, "Rolling Code"},
    {"Ford", "Focus 2012-2018", 433420000, "Fixed Code"},
    {"BMW", "3-Series 2012+", 434420000, "Rolling Code"},
    {"Audi", "A4 2010+", 433920000, "Rolling Code"},
    {"Chevrolet", "Cruze 2011-2016", 315000000, "Fixed Code"},
};
