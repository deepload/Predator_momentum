// EXPANDED SCENE CONFIGURATION - Core Domains Complete
ADD_SCENE(predator, main_menu_ui, MainMenuUI)

// Tesla & Car Attacks (Complete Domain)
...
// Bluetooth Attacks (Complete Domain)
...
// SubGHz Attacks (Complete Domain)
